...
- Tile labels showing the p value (or adjusted p value, if `p_adj` is set), in scientific notation with two decimal places (e.g. `3.12e-4`), can be enabled with `label = TRUE`;
